<template>
  ...
  <div id="map">
    ...
    <div class="isActiv2" v-else>
      <a href="/o-kompanii" target="_self" class="button primary is-outline">
        <p><span>Узнать больше о КОМПАНИИ</span></p>
      </a>
